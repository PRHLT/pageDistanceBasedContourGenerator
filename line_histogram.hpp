...
namespace prhlt {
    ...
    class Line_Histogram{
      ...
      void calculate(cv::Mat ex_angles_mat, string orientation_mode, string area_mode, int smoothing_factor,int derivate_window_size = 2);
        ...
        private:
            ...
            void calculate_angled_line_histogram(string mode);
